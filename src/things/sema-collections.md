...
![Collection Named Sue — actionable items with related activity](/public/things/sema-collections/collections-named-sue.png)

![Collection item expanded — description, assignees, due date](/public/things/sema-collections/collections-task-expanded.png)
...
![Project X — insights, recent activity, project details and repositories](/public/things/sema-collections/project-overview.png)

![Folder drill-down — contents, tech debt total, and top contributors](/public/things/sema-collections/project-folder-drilldown.png)

![File-level view — metric trends, top contributors, and recent activity](/public/things/sema-collections/project-file-view.png)
...
![Individual contributor view — insights, tasks & goals, recent activity across projects](/public/things/sema-collections/teams-contributor.png)

![Commit view — file changes across repositories with quality annotations](/public/things/sema-collections/teams-commit.png)

![Commit diff — line-level changes with no issues found](/public/things/sema-collections/teams-diff.png)
...
![A list of available reports. New custom reporting can be delivered to customers, including one-off analyses or regular reporting prepared by professional services.](/public/things/sema-collections/reports-list.png)

A list of available reports. New custom reporting can be delivered to customers, including one-off analyses or regular reporting prepared by professional services.

![Report example — commits and file changes with contributor and file type filters](/public/things/sema-collections/reports-chart.png)
