---
title: Re-design a code quality platform
...
link: /things/code-quality-platform/
date: 2019-11-01
category: software
tags: [things]
...
![Sema Code Quality Platform — Teams, Collections, Projects and contributor views](/public/things/code-quality-platform/hero-overview.jpg)
...
![Overview page](/public/things/code-quality-platform/platform-overview.png)

![Project overview](/public/things/code-quality-platform/platform-project-overview.png)

![Architecture metrics](/public/things/code-quality-platform/platform-architecture-metrics.png)

![Linter summary](/public/things/code-quality-platform/platform-linter-summary.png)

![Contribution details](/public/things/code-quality-platform/platform-contribution-details.png)

![Package dependence browser](/public/things/code-quality-platform/platform-package-dependence.png)

![One of many data tables](/public/things/code-quality-platform/platform-data-tables.png)
...
![Architecture / Code Journey — the 'what' drilldown](/public/things/code-quality-platform/journey-architecture.png)

![Something is Wrong! — an SMP user journey](/public/things/code-quality-platform/journey-something-wrong.png)

![Staffing Discovery — Executive and Manager journey](/public/things/code-quality-platform/journey-staffing-discovery.png)
...
![Balsamiq wireframe showing early data exploration concept](/public/things/code-quality-platform/balsamiq-wireframe.png)

![Balsamiq wireframe — language view showing JavaScript codebase metrics, velocity and dependencies](/public/things/code-quality-platform/balsamiq-language-view.png)

![Balsamiq wireframe — file view for capt_node.js showing contributor engagement and frequency](/public/things/code-quality-platform/balsamiq-file-view.png)

![Balsamiq wireframe — contributor profile for Sangar Git showing languages, notes and collaborators](/public/things/code-quality-platform/balsamiq-contributor-view.png)
...
![Contextual modals could be used to look at activities, analytics reports, teams, languages, files, commits, etc.](/public/things/code-quality-platform/sema-modal.png)
...
![Establishing parallels between code (projects → file) and people (teams → commit)](/public/things/code-quality-platform/shared-vision-ia.png)
...
![Striving for consistent layouts and patterns for an extensible front-end](/public/things/code-quality-platform/final-prototype.jpg)
...
![The home screen should feel light, not overwhelming. Here users see their owned or assigned collections, projects and teams.](/public/things/code-quality-platform/home-screen.png)
...
![Collections overview tracks actionable items and objectives](/public/things/code-quality-platform/collections-overview.png)

Collections overview tracks actionable items and objectives

![Single collection detailed view displays all recent development activity related to collection items](/public/things/code-quality-platform/collections-named-sue.png)

![Item detail menu where the type of objective, related file or folder, assignees and due dates are managed. Recent activity related to that objective is shown](/public/things/code-quality-platform/collections-task-expanded.png)
...
![Collections could be used for planning, coaching, or taking note of items to look further into. By default they would be private, but can be shared with other users.](/public/things/code-quality-platform/collections-detail.png)
...
![Project screen. Here we could surface insights, high-level details and activity. Accessing reports from here would filter to the repositories, contributors and files tied to that project.](/public/things/code-quality-platform/project-overview.png)

![Repository screen shows details about the repo and a familiar folder structure for exploring within it. Reports from here would show analytics about that repository (that's how the product works today)](/public/things/code-quality-platform/project-folder-drilldown.png)

![File screen shows commit details and insights on the file over time. Issues or notes could be auto-tagged or manually tagged. These examples are things Professional Services might typically point out to clients.](/public/things/code-quality-platform/project-file-view.png)
...
![Overview of Teams](/public/things/code-quality-platform/teams-overview.png)

Overview of Teams

![Profile of an individual contributor](/public/things/code-quality-platform/teams-contributor.png)

![Detail view of a commit automatically tags file changes for any anomolies or significant details](/public/things/code-quality-platform/teams-commit.png)

![A file change showing the actual line changes made](/public/things/code-quality-platform/teams-diff.png)
...
![This page holds a simple iFrame whitelabel embed from the BI tool. We implement filters on our own front end to maintain control of the inputs and learn from user behaviour.](/public/things/code-quality-platform/reports-chart.png)
